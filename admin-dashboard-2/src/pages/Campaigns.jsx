...
export default function Campaigns() {
  ...
  const stats = [
    ...
    { label: "Avg. Open Rate", value: "24.8%", icon: EnvelopeIcon, color: "text-purple-600", bg: "bg-purple-50" },
    ...
    <div className="p-10 max-w-[1600px] mx-auto min-h-screen bg-slate-50">
      ...
      <div className="flex justify-between items-end mb-10">
        ...
        <button 
          ...
          className="flex items-center gap-2 bg-slate-900 text-white px-6 py-3 rounded-xl font-bold uppercase tracking-widest hover:bg-slate-800 transition shadow-lg shadow-slate-900/20"
        >
          ...
          <div className="bg-white w-full max-w-lg rounded-3xl p-8 animate-fade-in">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="text" className="w-full p-3 border border-slate-200 rounded-xl font-bold text-slate-700 outline-none focus:ring-2 focus:ring-indigo-500/20" placeholder="e.g. Summer Promo" />
              </div>
              <div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {['SMS', 'Email', 'WhatsApp'].map(c => (
                    <button key={c} className="p-3 border border-slate-200 rounded-xl text-sm font-bold text-slate-600 hover:bg-slate-50 focus:border-indigo-600 focus:text-indigo-600 focus:bg-indigo-50">{c}</button>
                  ))}
                </div>
              </div>
            </div>
