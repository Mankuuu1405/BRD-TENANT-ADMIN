...
export default function ChannelPartners() {
    ...
    const mockData = [
      {
        ...
        firstName: "Amit",
        lastName: "Sharma",
        email: "amit.sharma@finpartners.com",
  ...
  const handleSave = () => {
    ...
    const newPartner = { ...form, id: Date.now() };
          ...
          <div className="bg-white w-full max-w-4xl rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            <div className="bg-slate-50 px-8 py-6 border-b border-slate-200 flex justify-between items-center">
               <div className="flex items-center gap-4">
                 <div className="w-10 h-10 rounded-xl bg-indigo-100 text-indigo-600 flex items-center justify-center"><Icons.Briefcase /></div>
                 <div>
            ...
            <div className="p-8 overflow-y-auto space-y-8">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="col-span-2"><h4 className="text-xs font-bold text-indigo-900 uppercase tracking-widest border-b border-indigo-100 pb-2 mb-2">Partner Details</h4></div>
               ...
               {/* 2. Business Info */}
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="col-span-2"><h4 className="text-xs font-bold text-indigo-900 uppercase tracking-widest border-b border-indigo-100 pb-2 mb-2">Business Information</h4></div>
               ...
               {/* 4. Status */}
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="col-span-2"><h4 className="text-xs font-bold text-indigo-900 uppercase tracking-widest border-b border-indigo-100 pb-2 mb-2">Status & Verification</h4></div>
