  ...
  return (
    <header className="fixed top-0 left-64 right-0 h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 z-30">
      ...
      <div className="flex items-center gap-3">
        ...
        <button onClick={() => window.dispatchEvent(new CustomEvent('navigate', { detail: 'profile' }))} className="h-9 w-9 rounded-full bg-primary-600 text-white grid place-items-center">TA</button>
      </div>
    </header>
  )
}
